...
public class Book extends BaseModel implements Serializable{
    ...
    private static final String FILE_PATH = "./src/main/resources/data/books.ser";
    ...
    public Book(String isbn, String title, float purchasedPrice, float sellingPrice, Integer quantity, Author author) {
        this.isbn = isbn;
        this.title = title;
    ...
    public boolean availableQuantity(int quantity){
